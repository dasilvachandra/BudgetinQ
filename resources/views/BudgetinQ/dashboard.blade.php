    ...
    <div class="col-xl-3 col-md-6 mb-4">
        <div class="card border-left-success shadow h-100 py-2">
            <div class="card-body">
                <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                        <div class="text-xs font-weight-bold text-success text-uppercase mb-1">Dana Keluar
                            (Monthly)</div>
        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                ...
                <div class="mt-4 text-center small">
                    ...
                    <span class="mr-2">
                        <i class="fas fa-circle" style="color:{{$textColor[$i]}};"></i> <a
                            href=''>{{$value->group_category}}</a>
                    </span>
                    @endforeach
                </div>
            </div>
    ...
    <div class="col-lg-6 mb-4">
        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                ...
                <h4 class="small font-weight-bold">{{$value->group_category}} <span class="float-right">20%</span>
                </h4>
                <div class="progress mb-4">
                    <div style="background-color:{{$textColor[$i]}};width: 20%" class="progress-bar" role="progressbar"
