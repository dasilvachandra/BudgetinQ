  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{ url('/') }}">
        ...
        <div class="sidebar-brand-text mx-3">BudgetinQ <sup>c</sup></div>
      </a>
              ...
              <div class="card border-left-primary shadow h-100 py-2">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">Dana Masuk (Monthly)</div>
            ...
            <div class="col-xl-3 col-md-6 mb-4">
              <div class="card border-left-success shadow h-100 py-2">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="text-xs font-weight-bold text-success text-uppercase mb-1">Dana Keluar (Monthly)</div>
            ...
            <div class="col-xl-3 col-md-6 mb-4">
              <div class="card border-left-success shadow h-100 py-2">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="text-xs font-weight-bold text-success text-uppercase mb-1">Saldo (Monthly)</div>
                ...
                <div class="card-body">
                  ...
                  <div class="mt-4 text-center small">
                      @foreach($gcPengeluaran as $i => $value)
                            <span class="mr-2">
                            <i class="fas fa-circle" style="color:{{$textColor[$i]}};"></i> <a href=''>{{$value->group_category}}</a>
                            </span>
                        @endforeach
                  </div>
                </div>
          ...
          <div class="row">
            ...
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary">Group Category Dana Masuk</h6>
                </div>

                <div class="card-body">
                    @foreach($gcPendapatan as $i => $value)
                        <h4 class="small font-weight-bold">{{$value->group_category}} <span class="float-right">20%</span></h4>
                        <div class="progress mb-4" >
                            <div style="background-color:{{$textColor[$i]}};width: 20%" class="progress-bar"  role="progressbar" aria-valuenow="20" aria-valuemin="0" aria-valuemax="100"></div>
                        </div>
                    @endforeach
                </div>
            </div>
            ...
            <div class="col-lg-6 mb-4">
              ...
              <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary">Group Category Dana Keluar</h6>
                </div>
