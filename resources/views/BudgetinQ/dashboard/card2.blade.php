            ...
            <div class="card-body">
                <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                        ...
                        <div class="h5 mb-0 font-weight-bold text-gray-800">{{$keuntungan}}</div>
                    </div>
                    <div class="col-auto">
                    <i class=" fa-2x text-gray-300"><b>Rp</b></i>
                    </div>
    ...
    <div class="col-xl-3 col-md-6 mb-4">
        <div class="card border-left-warning shadow h-100 py-2">
            <div class="card-body">
                <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                        <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">Kerugian</div>
                        <div class="h5 mb-0 font-weight-bold text-gray-800">{{$kerugian}}</div>
                    </div>
                    <div class="col-auto">
                        <i class=" fa-2x text-gray-300"><b>Rp</b></i>
                    </div>
