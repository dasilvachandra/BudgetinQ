				...
				<div class="p-3">
					<form class="user" id="form_create_pendapatan" method="POST">
						...
						<div class="form-group">
							...
							<input type="text" class="form-control form-control-user" ng-model="selectedTime" name="nama_pendapatan" required placeholder="Nama Pendapatan">
							</div>
						</div>
						...
						<div class="form-group row">
							<div class="col-sm-6 mb-3 mb-sm-0">
								...
								<div class="input-group form-float">
									...
									<select ng-repeat='row in gcPendapatan' ng-if="mGC==row.group_category_id" class="form-control " ng-model="mC" ng-change="ConChange(mC)" name="id_jenis_pendapatan" required>
